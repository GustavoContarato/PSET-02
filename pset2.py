...
class Image:
    def __init__(self, width, height, pixels):
        self.width = width ##Largura/Coluna/X
        self.height = height ##Altura/Linha/Y
        self.pixels = pixels

    def get_pixel(self, x, y):
        width = self.width
        index = x + width * y  ##Localizar em qual linha da lista está
...
if __name__ == '__main__':
    ...
    i = Image.load('test_images/cat.png').inverted().show()
    pass
